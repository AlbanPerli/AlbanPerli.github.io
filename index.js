...
var Wllama = class {
  ...
  createChatCompletion(messages, options) {
    return __async(this, null, function* () {
      ...
      return yield this.createCompletion(prompt, options);
    });
  }
  /**
   * Same with `createChatCompletion`, but returns an async iterator instead.
   */
  createChatCompletionGenerator(messages, options) {
    return __async(this, null, function* () {
      const prompt = yield this.formatChat(messages, true);
      return yield this.createCompletionGenerator(prompt, options);
    });
  }
  /**
